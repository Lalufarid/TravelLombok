...
import kotlinx.android.synthetic.main.fragment_admin_lobut.*

class AdminLobutFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_admin_lobut, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        rcView = view.findViewById(R.id.rv_adminlistlobut)
        rcView.setHasFixedSize(true)

        rcView.layoutManager = LinearLayoutManager(view.context)
        dbref = FirebaseDatabase.getInstance().getReference("Lombok Utara")
