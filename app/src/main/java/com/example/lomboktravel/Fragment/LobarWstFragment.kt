...
class LobarWstFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_lobar_wst, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val wisataAdapter = WisataAdapter(listWisata)

        wisataAdapter.setOnItemClickCallback(object : WisataAdapter.OnItemClickCallback{
            override fun onItemClicked(data: Wisata) {
                val wisataFragment = WisataFragment()
                val bundle = Bundle()
                bundle.putString(WisataFragment.EXTRA_NAME,data.nama)
                wisataFragment.arguments = bundle

                fragmentManager?.beginTransaction()?.apply {
                    replace(R.id.nav_host_fragment, wisataFragment, WisataFragment::class.java.simpleName)
                        .addToBackStack(null)
                        .commit()
                }
