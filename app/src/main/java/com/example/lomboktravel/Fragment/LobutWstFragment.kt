...
import kotlinx.android.synthetic.main.fragment_lobut_wst.*
import kotlinx.android.synthetic.main.fragment_lotim_wst.*

class LobutWstFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_lobut_wst, container, false)
    }
    ...
    private fun getData() {
        ...
        dbref.addValueEventListener(object : ValueEventListener{
            override fun onCancelled(error: DatabaseError) {
                Log.e("LobutFragment", error.message)
            }
